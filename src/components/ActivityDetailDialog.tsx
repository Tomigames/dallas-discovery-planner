...
export const ActivityDetailDialog = ({
  ...
  useEffect(() => {
    ...
    const handleKey = (e: KeyboardEvent) => {
      if (e.key === "ArrowRight") { e.preventDefault(); goToNextImage(); }
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto overflow-x-hidden" container={container}>
          <DialogHeader>
      ...
      <Dialog open={isGalleryOpen} onOpenChange={setIsGalleryOpen}>
        <DialogContent className="max-w-5xl w-[95vw] h-[85vh] flex flex-col gap-4" container={container}>
          <DialogHeader>
