    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 border-none text-[#1a73e8] hover:bg-[#E8F0FE] hover:text-[#174ea6]",
        ),
        ...
        cell: cn(
          ...
          "[&:has([aria-selected].day-range-start)]:bg-[#E8F0FE]",
          "[&:has([aria-selected].day-range-end)]:bg-[#E8F0FE]",
          "first:[&:has(.day-range-middle)]:rounded-l-full last:[&:has(.day-range-middle)]:rounded-r-full",
          "first:[&:has([aria-selected].day-range-start)]:rounded-l-full last:[&:has([aria-selected].day-range-end)]:rounded-r-full",
        ),
        day: cn(
          "mx-auto flex h-10 w-10 items-center justify-center rounded-full p-0 text-sm font-medium transition-colors",
